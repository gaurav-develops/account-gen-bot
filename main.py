...
async def generate(interaction: discord.Interaction, service: str):
    try:
        ...
        if iscookie:
            ...
            embd2.set_footer(text='discord.gg/x-zone',icon_url=interaction.user.avatar.url)
            ...
            embd.set_footer(text='discord.gg/x-zone',icon_url=interaction.user.avatar.url)
...
async def stock(interaction: discord.Interaction):
    ...
    if len(stock) <= 0 and len(prem_stock) <= 0:
        ...
        embd.set_footer(text='discord.gg/x-zone')
